...
Retrieves the current list of Proxied MVPDs for the ProxyMVPD identified by the apikey parameter.
...
Pushes an array of MVPDs integrated with the Proxy MVPD identified by the apikey parameter.
