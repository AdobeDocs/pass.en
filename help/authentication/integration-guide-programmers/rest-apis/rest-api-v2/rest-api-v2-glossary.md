...
This document provides definitions for terms used when integrating the Adobe Pass Authentication REST API V2 documentation and acts as an override to our legacy [Glossary](/help/authentication/kickstart/glossary.md).
...
Synonymous with former term used [requestor id](/help/authentication/kickstart/glossary.md#requestor-id).
