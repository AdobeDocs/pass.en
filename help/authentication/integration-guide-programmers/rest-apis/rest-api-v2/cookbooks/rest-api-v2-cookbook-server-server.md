...
To get the access token, the Programmer Service can act on behalf of a Streaming App and needs to follow steps as described in the [Dynamic Client Registration](../../rest-api-dcr/apis/dynamic-client-registration-apis-retrieve-access-token.md) documentation.
