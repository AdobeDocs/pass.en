...
This document provides Adobe Pass Authentication customers with structured rules and best practices specifically designed for AI-assisted development of TVE (TV Everywhere) applications using [REST API V2](rest-api-v2-overview.md).

By following the AI development rules outlined in this guide, developers can ensure their AI coding assistants help create compliant, performant, and maintainable integrations that adhere to the [mandatory requirements and recommended practices](rest-api-v2-checklist.md).

## Coding Assistants Rules {#coding-assistants-rules}

Rules provide system-level instructions to Agents. Think of them as persistent context, preferences, or workflows. The rules within this document are compatible with popular AI-powered coding assistants, and transform the [REST API V2 Checklist](rest-api-v2-checklist.md) into actionable AI development guidelines. 

Get started today by configuring your AI development environment with our comprehensive rule set, and experience the benefits of intelligent, compliant code generation for your Adobe Pass Authentication REST API V2 integration. Copy and paste below rules into your development environment's configuration file depending on the AI tool you are using.
