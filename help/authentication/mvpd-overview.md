...
Server Side - The hosted Adobe Primetime authentication Server. This is an application server that engages in back channel (server-to-server) communication with the authentication systems of MVPDs.
Client Side:
