...
*   For a description of the basic Primetime authentication entitlement flow, see [Entitlement Flow](/help/authentication/entitlement-flow.md).
...
>[!NOTE]
>
>Adobe encourages you to use only the Primetime authentication *public* APIs:
>
...
* *keyDictionary*: a dictionary data structure, with the following
  ...
  >[!NOTE]
  >
  >The actual User Metadata available to a Programmer depends on what an MVPD makes available. This list will be expanded as new metadata is made available and added into the Primetime authentication system.
