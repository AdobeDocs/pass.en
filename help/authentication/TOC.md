...
-   Product Releases {#product-releases}
    -   2026 {#2026}
        -   {hide-from-toc} [Adobe Pass Authentication 3.9.0 release notes](notes-releases/auth-rn-390.md)
        -   [Adobe Pass Authentication 3.8.0 release notes](notes-releases/auth-rn-380.md)
        -   [Adobe Pass Authentication 3.7.0 release notes](notes-releases/auth-rn-370.md)
        -   [Adobe Pass Authentication 3.6.0 release notes](notes-releases/auth-rn-360.md)
    -   2025 {#2025}
        -   [Adobe Pass Authentication Android 3.8.0 release notes](notes-releases/authn-rn-android-380.md)
        -   [Adobe Pass Authentication 3.5.0 release notes](notes-releases/auth-rn-350.md)
...
-   Integration Guide For Programmers {#integration-guide-programmers}
    ...
    -   REST APIs {#rest-apis}
        ...
        -   REST API V2 {#rest-api-v2}
            ...
            -   [REST API V2 AI Rules](integration-guide-programmers/rest-apis/rest-api-v2/rest-api-v2-ai-rules.md)
